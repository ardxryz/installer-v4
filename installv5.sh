...
animate_text "JIKA BELUM PUNYA LICENSE SILAHKAN BELI DI RYZEN/ARDHITA/ARGA , CUMAN 35K DAH FREE UPDATE LICENSE"
animate_text " CONTACT TRIO MAUT: "
echo -e "\033[31m"
...
echo -e "\033[32mWHATSAPP RYZEN : 085179849181\033[0m"
echo -e "\033[31mTELE RYZEN : REZZAJAKALI\033[0m"
echo ""
echo -e "${ORANGE}𝗖𝗢-𝗢𝗪𝗡𝗘𝗥¹${RESET}  ${BLUE}𝗡𝗔𝗩𝗜𝗚𝗔𝗧𝗢𝗥${RESET}"
echo -e "\033[32mWHATSAPP ARGA : 081802527761\033[0m"
echo -e "\033[31mTELE ARGA : ARGAANESIACLOUDCERDAS\033[0m"
echo ""
...
if [ "$INPUT_LICENSE" != "$VALID_LICENSE" ]; then
    echo -e "${GREEN}Buy dulu Gih Ke Ardhita/Ryzen/Arga${RESET}"
    echo -e "${YELLOW}WHATSAPP : 6289697318010/6285179849181/6281802527761${RESET}"
    echo -e "${YELLOW}HARGA TOKEN : 35K FREE UPDATE JIKA ADA TOKEN BARU${RESET}"
    echo -e "${YELLOW}©Trio Maut${RESET}"
...
# Menampilkan opsi tanpa animasi
  ...
  echo -e "${RED}⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠻⣿⣿⣿⠟⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀⠀⠀⠀    ⠀ ⠀⠀Auto Installer ArdxRyzxGan ⠀⠀   ⠀   ⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀ ⠀⠀ ⠀⠀⠀⠀⠀⠀---------------------------⠀  ⠀  ⠀⠀⠀⠀ ⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀ ⠀⠀⠀⠀• WhatsApp¹ : 6289697318010⠀⠀           ⠀⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀ ⠀⠀⠀⠀• WhatsApp² : 6283163553339⠀⠀  ⠀           ⠀⠀  ⠀⠀${NC}"
  echo -e "${RED}⠀⠀ ⠀⠀⠀⠀• WhatsApp³ : 6281802527761⠀⠀             ⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀ ⠀⠀⠀⠀• Versi : 4.0                                             ${NC}"
  echo -e "${RED}⠀⠀ ⠀⠀⠀⠀• Credits : ArdxRyzxGan⠀⠀⠀⠀ ⠀⠀  ⠀       ⠀⠀⠀ ⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀⠀⠀⠀⠀⠀        @Support By Ortu⠀  ⠀    ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "                                                                     "
 echo -e "${BLUE}[+] ========================================================== [+]${NC}"
echo "𝗧𝗛𝗘𝗠𝗘 ( 𝗙𝗜𝗟𝗘𝗦 )"
echo "1. INSTALL THEME ELYSIUM PTERODACTYL"
echo "2. ENIGMA PREMIUM PTERODACTYL"
echo "3. INSTALL TEMA STELLAR PTERODACTYL"
echo "4. INSTALL TEMA NOOKTHEME PTERODACTYL"
echo ""
echo "𝗧𝗛𝗘𝗠𝗘 ( 𝗣𝗟𝗨𝗚𝗜𝗡𝗦 ) "
echo "5. INSTALL NEBULA THEME PTERODACTYL"
echo "6. ADMIN PANEL THEME PTERODACTYL"
echo ""
echo "𝗔𝗗𝗗𝗢𝗡 ( 𝗙𝗜𝗟𝗘𝗦 )"
echo "7. INSTALL ADDON AUTO SUSPEND PTERODACTYL"
echo "8. INSTALL GOOGLE ANALITIC PTERODACTYL"
echo ""
echo "𝗣𝗧𝗘𝗥𝗢𝗗𝗔𝗖𝗧𝗬𝗟 ( 𝗘𝗗𝗜𝗧 )"
echo "9. UBAH BACKROUND PTERODACTYL"
echo "10. HAPUS BACKROUND PTERODACTYL"
echo "11. HAPUS THEME/ADDON"
echo ""
echo "𝗜𝗡𝗦𝗧𝗔𝗟𝗟𝗘𝗥"
echo "12. MATIKAN SEMUA ANIMASI INSTALLER"
echo "13. HACKBACK PANEL"
echo "14. GANTI PW VPS"
echo "15. INSTALL PANEL"
echo "16. INSTALL WINGS"
echo "17. UNINSTALL PANEL"
echo "18. BUAT NODE PANEL"
echo "19. CONFIGURE WINGS"
echo ""
echo "𝗚𝗔𝗕𝗨𝗧"
echo "20. SPAM PAIRING MENU"
echo "21. KELUAR DARI INSTALLER"
 echo -e "${BLUE}[+] ============================================== [+]${NC}"
read -p "PILIH OPSI (1-21): " OPTION
case "$OPTION" in
    1)
...
read -p "MASUKAN NOMOR WHATSAPP ANDA ( ISI MENGGUNAKAN AWALAN CODE NOMOR EXAMPLE : 6289697318010 ) : " nomor_baru
  ...
  clear
    ...
    22)
       ...
       limau
        ...
        ;;
    20)
       git clone https://github.com/ardxryz/SpamPairingWA
       cd SpamPairingWA
       npm i
       npm start
        exit 0
    ...
    yarn add react-feather
            cd /var/www/
            apt install git
            git clone https://github.com/ardxryz/installer
