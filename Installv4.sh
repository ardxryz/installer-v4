...
animate_text "JIKA BELUM PUNYA LICENSE SILAHKAN BELI DI RYZEN/ARDHITA , CUMAN 20K DAH FREE UPDATE LICENSE"
...
echo -e "\033[31mTELE BARMODS : REZZAJAKALI\033[0m"
echo ""
