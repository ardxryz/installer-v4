...
echo -e "\033[32mWHATSAPP ARDHITA : 089603214173\033[0m"
...
echo -e "\033[31mTELE RYZEN : RYZENAJAKALI\033[0m"
echo ""
...
if [ "$INPUT_LICENSE" != "$VALID_LICENSE" ]; then
    echo -e "${GREEN}Buy dulu Gih Ke Ardhita/Ryzen${RESET}"
    echo -e "${YELLOW}WHATSAPP : 6289603214173/6285179849181${RESET}"
...
# Menampilkan opsi tanpa animasi
  ...
  echo -e "${RED}⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠻⣿⣿⣿⠟⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀⠀⠀⠀  ⠀ ⠀⠀⠀Auto Installer ArdxRyz ⠀⠀  ⠀ ⠀⠀⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀--------------------------⠀⠀⠀  ⠀⠀ ⠀⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀⠀⠀⠀⠀⠀• WhatsApp¹ : 628903214173⠀⠀    ⠀⠀⠀⠀⠀⠀⠀⠀${NC}"
  echo -e "${RED}⠀⠀ ⠀  ⠀⠀• WhatsApp² : 6285179849181⠀⠀ ⠀ ⠀⠀⠀⠀  ⠀⠀${NC}"
  echo -e "${RED}            • Versi : 5.0                                       ${NC}"
  echo -e "${RED}⠀⠀⠀⠀⠀⠀  • Credits : ArdxRyz⠀⠀⠀⠀ ⠀⠀⠀⠀       ⠀⠀⠀ ⠀⠀⠀${NC}"
